const PATHS = {
  ...
  pen: (
    <>
      <path d="m5 19 1.1-4.3L16.8 4a2.1 2.1 0 0 1 3 3L9.1 17.7Z" />
  ...
  eraser: (
    <>
      <path d="m7.2 18.5-3-3a2 2 0 0 1 0-2.8l8.5-8.5a2 2 0 0 1 2.8 0l4.3 4.3a2 2 0 0 1 0 2.8l-7.2 7.2Z" />
      <path d="m9.5 8.5 7 7" />
      <path d="M12.5 18.5H21" />
    </>
  ),
  undo: (
    <>
